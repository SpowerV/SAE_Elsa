...
<div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" name="passwoord" class="form-control"  placeholder="Entrer un password">
  </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" name="insertdata" class="btn btn-primary">Sauvegarder</button>
      </div>
